        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg shadow-gray-300/50 dark:shadow-black/20 p-5 sm:p-6 md:p-8 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
              <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-blue-700 dark:text-blue-300 transition-colors duration-200">Contact Information</h2>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <FaPhone className="text-blue-600 dark:text-blue-400 text-lg sm:text-xl flex-shrink-0 transition-colors duration-200" />
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 transition-colors duration-200">
                      <a href="tel:+918800203969" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">+91 8800203969</a>
                    </p>
                  </div>
                </div>                <div className="flex items-center space-x-3 sm:space-x-4">
                  <FaEnvelope className="text-blue-600 dark:text-blue-400 text-lg sm:text-xl flex-shrink-0 transition-colors duration-200" />
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-gray-100 transition-colors duration-200">Email</h3>
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 transition-colors duration-200">
                      <a href="mailto:info@cyinov.com" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">info@cyinov.com</a>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg shadow-gray-300/50 dark:shadow-black/20 p-5 sm:p-6 md:p-8 border border-gray-200 dark:border-gray-700 transition-colors duration-200">              <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-blue-700 dark:text-blue-300 transition-colors duration-200">Connect With Us</h2>
              <div className="flex space-x-5 sm:space-x-6">
                <a href="https://www.linkedin.com/company/cyinovconsulting/" target="_blank" rel="noopener noreferrer" 
                   className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700"
                   aria-label="LinkedIn">
            ...
            <div className="bg-gray-800 rounded-lg shadow-lg shadow-black/20 p-5 sm:p-6 md:p-8 border border-gray-700 transition-colors duration-200">
              <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-3 sm:mb-4 text-blue-300 transition-colors duration-200">Need Immediate Assistance?</h2>
              ...
              <div className="mt-4 sm:mt-5 flex flex-col xs:flex-row gap-3 sm:gap-4">
                <a href="tel:+918800203969" className="inline-flex items-center justify-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800">
                  <FaPhone className="mr-2" /> Call Us
                </a>
                <a href="mailto:info@cyinov.com" className="inline-flex items-center justify-center px-4 py-2 bg-transparent hover:bg-gray-700 border border-blue-500 text-blue-400 text-sm rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800">
